...
"""
@File     : read_graph_pyg.py
@Project  : gnn_base_model
@Time     : 2022/12/8 17:18
@Author   : Pu Chengtao
@Contact_2: 2319189860@qq.com
@Software : PyCharm
@Last Modify Time      @Version     @Desciption
--------------------       --------        -----------
2022/12/8 17:18        1.0             None
"""
import pandas as pd
import torch
...
import numpy as np
from utils.read_graph_raw import read_csv_graph_raw, read_csv_heterograph_raw, read_binary_graph_raw, \
